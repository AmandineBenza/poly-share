...
/**
 * Unit tests for {@link ServletYo}.
 */
@RunWith(JUnit4.class)
public class TestServletYo {
	...
	private ServletYo servletUnderTest;
	...
	public void setUp() throws Exception {
		...
		servletUnderTest = new ServletYo();
	}
	...
	public void doGet_writesResponse() throws Exception {
		...
		.named("ServletYo response").contains("Yo");
	}
}
